...
connection_fullMatch = "{'en': 'Connection list - Full match', 'fr': 'Liste de connexion - Correspondance complète', 'it': 'Elenco connessioni - Corrispondenza completa', 'pt': 'Lista de conexões - Correspondência completa', 'zh': '连接列表-完全匹配', 'nl': 'Verbindingslijst - Volledige overeenkomst', 'es': 'Lista de conexiones - Coincidencia completa', 'cs': 'Seznam připojení - Úplná shoda', 'de': 'Verbindungsliste - Vollständige Übereinstimmung'}"
connection_startDevice ="{'en': 'Connection list - Starting Device match', 'fr': 'Liste de connexion - Correspondance du dispositif de démarrage', 'it': 'Elenco connessioni - Corrispondenza del dispositivo di avvio', 'pt': 'Lista de conexões - Correspondência do dispositivo de partida', 'zh': '连接列表-启动设备匹配', 'nl': 'Verbindingslijst - Overeenkomst startapparaat', 'es': 'Lista de conexiones - Coincidencia de dispositivo de inicio', 'cs': 'Seznam připojení - Shoda začínajícího zařízení', 'de': 'Verbindungsliste - Übereinstimmung mit dem Startgerät'}"
connection_endDevice ="{'en': 'Connection list - Ending Device match', 'fr': 'Liste de connexion - Correspondance du dispositif final', 'it': 'Elenco connessioni - Corrispondenza del dispositivo finale', 'pt': 'Lista de conexões - Correspondência do dispositivo final', 'zh': '连接列表-结束设备匹配', 'nl': 'Verbindingslijst - Overeenkomst eindapparaat', 'es': 'Lista de conexiones - Coincidencia de dispositivo final', 'cs': 'Seznam připojení - Shoda koncového zařízení', 'de': 'Verbindungsliste - Übereinstimmung mit dem Endgerät'}"
connection_crossDevice="{'en': 'Connection list - Cross Device match', 'fr': 'Liste de connexion - Correspondance entre dispositifs', 'it': 'Elenco connessioni - Corrispondenza tra dispositivi', 'pt': 'Lista de conexões - Correspondência entre dispositivos', 'zh': '连接列表-跨设备匹配', 'nl': 'Verbindingslijst - Overeenkomst tussen apparaten', 'es': 'Lista de conexiones - Coincidencia entre dispositivos', 'cs': 'Seznam připojení - Shoda mezi zařízeními', 'de': 'Verbindungsliste - Übereinstimmung zwischen Geräten'}"
connection_unmatched ="{'en': 'Connection list - Unmatched Values', 'fr': 'Liste de connexion - Valeurs non appariées', 'it': 'Elenco connessioni - Valori non corrispondenti', 'pt': 'Lista de conexões - Valores não correspondentes', 'zh': '连接列表-不匹配的值', 'nl': 'Verbindingslijst - Niet-overeenkomende waarden', 'es': 'Lista de conexiones - Valores no coincidentes', 'cs': 'Seznam připojení - Nesouhlasící hodnoty', 'de': 'Verbindungsliste - Nicht übereinstimmende Werte'}"
